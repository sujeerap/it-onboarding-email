...
app.get('/', (req, res) => {
  res.json({
    ...
    from: process.env.SMTP_FROM || process.env.SMTP_EMAIL || 'NOT CONFIGURED',
...
app.listen(PORT, () => {
  ...
  console.log(`📧 Auth User: ${process.env.SMTP_EMAIL || 'NOT CONFIGURED'}`);
  console.log(`📧 From: ${process.env.SMTP_FROM || process.env.SMTP_EMAIL || 'NOT CONFIGURED'}\n`);
});
